...
public class MVSYLevelDownOne extends Structure {
    ...
    public static final Codec<MVSYLevelDownOne> CODEC = RecordCodecBuilder.<MVSYLevelDownOne>mapCodec(instance ->
            instance.group(MVSYLevelDownOne.settingsCodec(instance),
                    ...
                    Holder.codec(Registry.STRUCTURE_SET_REGISTRY).listOf().fieldOf("structure_set_to_avoid").orElse(new ArrayList<>()).forGetter(config -> config.structureSetToAvoid)
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        for (Holder<StructureSet> structureSetToAvoid : structureSetToAvoid) {
            if (context.chunkGenerator().hasStructureChunkInRange(structureSetToAvoid, context.randomState(), context.seed(), chunkPos.x, chunkPos.z, 10)) {
