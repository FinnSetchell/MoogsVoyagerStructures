...
public class MVSGenericSmallJigsawStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<MVSGenericSmallJigsawStructure> CODEC = RecordCodecBuilder.<MVSGenericSmallJigsawStructure>mapCodec(instance ->
            instance.group(MVSGenericSmallJigsawStructure.settingsCodec(instance),
    ...
    public StructureType<?> type() {
        return MVSStructures.MVS_GENERIC_SMALL_JIGSAW_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}