...
public class MVSGenericConfig implements FeatureConfiguration {

    public static final Codec<MVSGenericConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, MVSGenericConfig::new));
    ...
    public MVSGenericConfig(Holder<StructureTemplatePool> startPool, int size, int minYAllowed,
