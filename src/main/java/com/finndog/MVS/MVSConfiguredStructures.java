...
public class MVSConfiguredStructures {
    ...
    public static StructureFeature<?, ?> CONFIGURED_BEEDOME = MVSStructures.BEEDOME.get().configured(IFeatureConfig.NONE);
    ...
    public static StructureFeature<?, ?> CONFIGURED_BIRCHTREE2 = MVSStructures.BIRCHTREE2.get().configured(IFeatureConfig.NONE);
    ...
    public static StructureFeature<?, ?> CONFIGURED_CRIMSONENCHANTINGTABLE = MVSStructures.CRIMSONENCHANTINGTABLE.get().configured(IFeatureConfig.NONE);
    ...
    public static StructureFeature<?, ?> CONFIGURED_FLOATINGISLANDS = MVSStructures.FLOATINGISLANDS.get().configured(IFeatureConfig.NONE);
    ...
    public static StructureFeature<?, ?> CONFIGURED_LAVAPOOL = MVSStructures.LAVAPOOL.get().configured(IFeatureConfig.NONE);
    ...
    public static StructureFeature<?, ?> CONFIGURED_SMALLSWAMPHOUSE = MVSStructures.SMALLSWAMPHOUSE.get().configured(IFeatureConfig.NONE);
    public static StructureFeature<?, ?> CONFIGURED_SPRUCELOGPILE = MVSStructures.SPRUCELOGPILE.get().configured(IFeatureConfig.NONE);
    public static StructureFeature<?, ?> CONFIGURED_STONEBEE = MVSStructures.STONEBEE.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_beedome"), CONFIGURED_BEEDOME);
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_birchtree2"), CONFIGURED_BIRCHTREE2);
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_crimsonenchantingtable"), CONFIGURED_CRIMSONENCHANTINGTABLE);
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_floatingislands"), CONFIGURED_FLOATINGISLANDS);
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_lavapool"), CONFIGURED_LAVAPOOL);
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_smallswamphouse"), CONFIGURED_SMALLSWAMPHOUSE);
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_sprucelogpile"), CONFIGURED_SPRUCELOGPILE);
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_stonebee"), CONFIGURED_STONEBEE);
        ...
        */
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.BEEDOME.get(), CONFIGURED_BEEDOME);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.BIRCHTREE2.get(), CONFIGURED_BIRCHTREE2);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.CRIMSONENCHANTINGTABLE.get(), CONFIGURED_CRIMSONENCHANTINGTABLE);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.FLOATINGISLANDS.get(), CONFIGURED_FLOATINGISLANDS);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.LAVAPOOL.get(), CONFIGURED_LAVAPOOL);
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.SMALLSWAMPHOUSE.get(), CONFIGURED_SMALLSWAMPHOUSE);
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.SPRUCELOGPILE.get(), CONFIGURED_SPRUCELOGPILE);
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.STONEBEE.get(), CONFIGURED_STONEBEE);
