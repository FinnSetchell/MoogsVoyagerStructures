...
public class MVSStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> BEEDOME = DEFERRED_REGISTRY_STRUCTURE.register("beedome", () -> (new BeeDome(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> BIRCHTREE2 = DEFERRED_REGISTRY_STRUCTURE.register("birchtree2", () -> (new BirchTree2(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> CRIMSONENCHANTINGTABLE = DEFERRED_REGISTRY_STRUCTURE.register("crimsonenchantingtable", () -> (new CrimsonEnchantingTable(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> FLOATINGISLANDS = DEFERRED_REGISTRY_STRUCTURE.register("floatingislands", () -> (new FloatingIslands(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> LAVAPOOL = DEFERRED_REGISTRY_STRUCTURE.register("lavapool", () -> (new LavaPool(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> SMALLSWAMPHOUSE = DEFERRED_REGISTRY_STRUCTURE.register("smallswamphouse", () -> (new SmallSwampHouse(NoFeatureConfig.CODEC)));
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> STONEBEE = DEFERRED_REGISTRY_STRUCTURE.register("stonebee", () -> (new StoneBee(NoFeatureConfig.CODEC)));
