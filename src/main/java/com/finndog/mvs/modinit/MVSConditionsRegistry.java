...
import com.finndog.mvs.modinit.registry.CustomRegistry;
...
public final class MVSConditionsRegistry {
    ...
    public static final CustomRegistry<Supplier<Boolean>> MVS_JSON_CONDITIONS_REGISTRY = CustomRegistry.of(MVSMain.MODID, MVS_JSON_CONDITIONS_KEY, false, false, true);
