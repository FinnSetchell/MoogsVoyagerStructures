...
public class CrimsonEnchantingTable extends Structure<NoFeatureConfig> {
    public CrimsonEnchantingTable(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
...
/*    protected boolean ledgeCheck(ChunkGenerator chunkGenerator, BiomeProvider biomeProvider, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig config) {
...
*        if (super.ledgeCheck(chunkGenerator, biomeProvider, seed, chunkRandom, chunkX, chunkZ, biome, chunkPos, config)) {
*
*            int posX = chunkX << 4;
*            int posZ = chunkZ << 4;
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(MVSMain.MODID, "crimsonenchantingtable/start_pool")),
            ...
            MVSMain.LOGGER.log(Level.DEBUG, "crimson enchanting table at " +
