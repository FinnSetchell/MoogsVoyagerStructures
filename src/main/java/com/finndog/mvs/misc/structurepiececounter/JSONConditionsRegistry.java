...
public final class JSONConditionsRegistry {
    ...
    public static final Registry<Supplier<Boolean>> MVS_JSON_CONDITIONS_REGISTRY = (Registry<Supplier<Boolean>>) FabricRegistryBuilder.createSimple(TEMP_CLASS_TYPE.getClass(), MVS_JSON_CONDITIONS_KEY.location()).buildAndRegister();
