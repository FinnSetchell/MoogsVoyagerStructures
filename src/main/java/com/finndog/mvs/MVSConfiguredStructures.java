...
public class MVSConfiguredStructures {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_COMMONOVERWORLDSTRUCTURES = MVSStructures.COMMONOVERWORLDSTRUCTURES.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(MVSMain.MODID, "configured_commonoverworldstructures"), CONFIGURED_COMMONOVERWORLDSTRUCTURES);
        ...
        */
        ...
        FlatGenerationSettings.STRUCTURE_FEATURES.put(MVSStructures.COMMONOVERWORLDSTRUCTURES.get(), CONFIGURED_COMMONOVERWORLDSTRUCTURES);
