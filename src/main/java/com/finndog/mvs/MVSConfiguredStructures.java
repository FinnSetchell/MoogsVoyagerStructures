...
public class MVSConfiguredStructures {
     ...
     */
    public static ConfiguredStructureFeature<?, ?> CONFIGURED_RUN_DOWN_HOUSE = com.finndog.mvs.MVSStructures.RUN_DOWN_HOUSE.configure(DefaultFeatureConfig.DEFAULT);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new Identifier(com.finndog.mvs.MVSMain.MODID, "configured_run_down_house"), CONFIGURED_RUN_DOWN_HOUSE);
    }
}
