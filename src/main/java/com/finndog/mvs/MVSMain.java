...
import com.finndog.mvs.mixin.StructuresConfigAccessor;
...
public class MVSMain implements ModInitializer {
    ...
    public void onInitialize() {
         ...
         */
        com.finndog.mvs.MVSStructures.setupAndRegisterStructureFeatures();
        ...
        BiomeModifications.create(new Identifier(MODID, "run_down_house_addition"))
                .add(   // Describes what we are doing. SInce we are adding a structure, we choose ADDITIONS.
                        ...
                        context -> {
                            context.getGenerationSettings().addBuiltInStructure(MVSConfiguredStructures.CONFIGURED_RUN_DOWN_HOUSE);
                        });
    }
    ...
    public static void removeStructureSpawningFromSelectedDimension() {
        ...
        Identifier runAfterFabricAPIPhase = new Identifier(com.finndog.mvs.MVSMain.MODID, "run_after_fabric_api");
        ...
        ServerWorldEvents.LOAD.register(runAfterFabricAPIPhase, (MinecraftServer minecraftServer, ServerWorld serverWorld)->{
            ...
            tempMap.keySet().remove(MVSStructures.RUN_DOWN_HOUSE);
            //}
