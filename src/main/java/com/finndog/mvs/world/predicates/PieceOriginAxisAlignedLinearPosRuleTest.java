package com.finndog.mvs.world.predicates;

import com.finndog.mvs.modinit.MVSPredicates;
...
public class PieceOriginAxisAlignedLinearPosRuleTest extends PosRuleTest {
    ...
    protected PosRuleTestType<?> getType() {
        return MVSPredicates.PIECE_ORIGIN_AXIS_ALIGNED_LINEAR_POS_RULE_TEST.get();
    }
}
