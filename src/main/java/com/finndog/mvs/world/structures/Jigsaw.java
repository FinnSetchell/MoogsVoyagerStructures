...
public class Jigsaw extends Structure {
    ...
    public static final Codec<Jigsaw> CODEC = RecordCodecBuilder.<Jigsaw>mapCodec(instance ->
            instance.group(Jigsaw.configCodecBuilder(instance),
    ...
    public Jigsaw(Structure.Config config,
    ...
    public StructureType<?> getType() {
        return MVSStructures.JIGSAW; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
