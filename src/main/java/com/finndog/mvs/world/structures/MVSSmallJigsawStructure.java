...
public class MVSSmallJigsawStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MVSSmallJigsawStructure() {
        ...
        super(CODEC, MVSSmallJigsawStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MVSSmallJigsawStructure.isFeatureChunk(context)) {return Optional.empty();}
