...
public final class MVSStructurePlacementType {
    public static final ResourcefulRegistry<StructurePlacementType<?>> STRUCTURE_PLACEMENT_TYPE = ResourcefulRegistries.create(Registry.STRUCTURE_PLACEMENT_TYPE, MVSCommon.MODID);
